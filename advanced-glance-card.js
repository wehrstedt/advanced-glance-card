!(function (t, e) {
  ...
  class o {
    constructor(t, e) {
      ...
      const i = [],
        o = [],
        l = document.createTreeWalker(e.content, 133, null, !1);
      let h = 0,
        p = -1,
        u = 0;
      const {
          ...
          if ((p++, 1 === t.nodeType)) {
            if (t.hasAttributes()) {
              const e = t.attributes,
                { length: s } = e;
              let i = 0;
              for (let t = 0; t < s; t++) a(e[t].name, r) && i++;
              for (; i-- > 0; ) {
                const e = f[u],
                  s = d.exec(e)[2],
                  i = s.toLowerCase() + r,
            ...
            "TEMPLATE" === t.tagName &&
              (o.push(t), (l.currentNode = t.content));
    ...
    for (; n.nextNode(); ) {
      ...
      for (
        t.previousSibling === d && (d = null),
          e.has(t) && (c.push(t), null === d && (d = t)),
          null !== d && l++;
        void 0 !== o && o.index === a;

      )
        (o.index = null !== d ? -1 : o.index - l), (r = u(i, r)), (o = i[r]);
    }
    ...
    getHTML() {
      ...
      for (let o = 0; o < t; o++) {
        ...
        e +=
          null === l
            ? t + (n ? w : i)
            : t.substr(0, l.index) + l[1] + l[2] + r + l[3] + s;
      }
  ...
  (class {
    handleAttributeExpressions(t, e, s, i) {
      const n = e[0];
      if ("." === n) {
        return new A(t, e.slice(1), s).parts;
      }
      if ("@" === n) return [new O(t, e.slice(1), i.eventContext)];
  ...
  class G extends HTMLElement {
    ...
    static _propertyValueToAttribute(t, e) {
      ...
      const s = e.type,
        i = e.converter;
      return ((i && i.toAttribute) || B.toAttribute)(t, s);
    }
    initialize() {
      (this._updateState = 0),
    ...
    (Z.render = (t, s, i) => {
      ...
      if (
        (((t, s, i) => {
          ...
          void 0 === n &&
            (e(s, s.firstChild),
            j.set(s, (n = new N(Object.assign({ templateFactory: k }, i)))),
            n.appendInto(s)),
            n.setValue(t),
            n.commit();
        ...
        F(n, l, i), e(s, s.firstChild), s.appendChild(l), j.set(s, t);
      }
  ...
  function it(t, e) {
    ...
    if (Array.isArray(t)) {
      const [s, ...i] = t;
      return st.hasOwnProperty(s) ? st[s](e, i) : st["="](e, i);
    }
  ...
  function nt(t, e) {
    ...
    if (t.when) {
      const { state: s, entity: i = t.entity, attributes: n } =
        ...
        r = e[i];
      if (void 0 !== s && !it(s, r.state)) return !1;
      return Object.entries(n || {}).every(([t, e]) => it(e, r.attributes[t]));
    }
    return !0;
  }
  !(function (t) {
    console.info(`%cadvanced-glance-card: ${t}`, "font-weight: bold");
  })("0.1.0");
  class rt extends Z {
    static get properties() {
      return { config: Object, _hass: Object };
    }
    static get styles() {
      return [tt];
    }
    constructor() {
      super(), (this.config = {}), (this._hass = {});
    }
    setConfig(t) {
      if (!t.entities || 0 === t.entities.length)
        throw new Error("You need to define at least one entity");
      (this.entities = (t.entities || []).map(et)), (this.config = t);
    }
    set hass(t) {
      this._hass = t;
    }
    render() {
      return R`
      <ha-card
        style="--glance-column-width:${
          100 / Math.min(this.entities.length, 3)
        }%;"
      >
    ...
    renderHeader(t) {
      if ("string" == typeof t || Object.keys(t).length < 2)
        return R` <h1 class="card-header">${t}</h1> `;
      {
        const e = 100 / Object.keys(t).length,
          s = (t) => (t && t.width) || e,
          i = (t) => (void 0 === t ? "none" : "inline-block"),
          n = (t, e) => (t ? t.align : "") || e,
          r = (t) =>
            t && "string" == typeof t.color
              ? `color: ${t.color}`
              : Array.isArray(t)
              ? ((t = t.filter((t) => nt(t, this._hass.states))[0]), r(t))
              : "",
          o = (t) => {
            if (void 0 === t) return "";
            if ("string" == typeof t) return t;
            if ("string" == typeof t.text) return t.text;
            if (t.entity) return this.renderDomainCover(t.entity);
            if (Array.isArray(t))
              return (t = t.filter((t) => nt(t, this._hass.states))[0]), o(t);
            throw new Error("Invalid title: " + JSON.stringify(t));
          };
        return R`
        <div>
          <h1
            ...
            style="display: ${i(
              t.left
            )}; float: left; width: calc(${s(t.left)}% - 32px); text-align: ${n(t.left, "left")};${r(t.left)}"
          >
            ${o(t.left)}
          </h1>
          <h1
            ...
            style="display: ${i(
              t.center
            )}; width: calc(${s(t.center)}% - 32px); text-align: ${n(t.center, "center")};${r(t.center)}"
          >
            ${o(t.center)}
          </h1>
          <h1
            ...
            style="display: ${i(
              t.right
            )}; float: right; width: calc(${s(t.right)}% - 32px); text-align: ${n(t.right, "right")};${r(t.right)}"
          >
            ${o(t.right)}
          </h1>
        </div>
    ...
    renderDomainCover(t) {
      const e = this._hass.states[t],
        s = "closed" === e.state || 0 === e.state,
        i = "open" === e.state || 100 === e.state;
      return R`
    ...
    renderEntity(t) {
      ...
      return R`
      <div class="entity" @click=${() => {
        if (t.tap_action) {
          if ("call-service" !== t.tap_action.action)
            throw new Error("Unsupported action type: " + t.tap_action.action);
          {
            const [e, s] = t.tap_action.service.split(".");
            this._hass.callService(e, s, t.tap_action.service_data);
          }
        } else this.openEntityPopover(t.entity);
      }}>
        <div class="name">
    ...
    computeStateName(t) {
      return void 0 === t.attributes.friendly_name
        ? this.computeObjectId(t.entity_id).replace(/_/g, " ")
  ...
  return (
    window.customElements.define("advanced-glance-card", rt),
